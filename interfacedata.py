...
def regula_falsi(V,Phi,eta,sigma_n,psi,V0,a):
    ...
    fv = V + a*sigma_n/eta*np.arcsinh(0.5*V/V0*np.exp(psi/a)) - Phi/eta
    fl = Vl + a*sigma_n/eta*np.arcsinh(0.5*Vl/V0*np.exp(psi/a)) - Phi/eta
    fr = Vr + a*sigma_n/eta*np.arcsinh(0.5*Vr/V0*np.exp(psi/a)) - Phi/eta
